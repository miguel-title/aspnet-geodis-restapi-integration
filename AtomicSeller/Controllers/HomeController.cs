...
namespace AtomicSeller.Controllers
{
    public class HomeController : BaseController
    {
        ...
        {
            ShipmentResponse _Result = new GEODIS().GEODIS_SendParcelData();
        ...
        {
            List<string> _ResponseHeader = new GEODIS().GEODIS_GetShipmentLabel();
        ...
        {
            List<string> _ResponseHeader = new GEODIS().GEODIS_GetTrackingNumber();
